...
const Experience = () => {
    const experiences = [
        {
            position: "Graduate Assisant (Digitalization Lab)",
            employer: "University of Alabama, Birmingham",
            duration: "Apr 2024 - Present",
            description: "Working on Digitial Preservation of historical records using Python Scripts from different universities and facilitating those records for future research accross USA.",
        ...
        },
        {
            ...
            description: "Trained on Python, SQL, GCP, PySpark with 80+ hands-on assignments. Designed Hospital Management System capstone project using Python, Tkinter, and SQLlite. Built ETL pipelines on GCP Dataproc, extracting data from GCS, and loading processed data into GCS and Bigquery for both batch & streaming data. ",
